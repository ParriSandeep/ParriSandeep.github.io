...
function toAccomplishments() {
  var element = document.getElementById("Accomplishments");
  var headerOffset = 85;
  var elementPosition = element.getBoundingClientRect().top;
  var offsetPosition = elementPosition + window.pageYOffset - headerOffset;
...
new Typewriter(".loading-text", {
  strings: ["Preparing a digital handshake..............!"],
  autoStart: true,
  delay: 40,
  cursor: "|",
  deleteSpeed: 10,
...
const projectData = [
  {
    ...
    thumbnail: "/Sandeep-Portfolio/img/icon/favicon/transaction.jpg",
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="https://github.com/ParriSandeep" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
